...
const form = `
<form class="px-4 sm:px-8 pt-4 sm:pt-8 md:p-0 md:flex-1 md:p-5"  >
    ...
    <fieldset class="flex flex-col mb-4 md:mb-0 ]  md:flex-1  md:flex">
        <label for="mortgage-term" class="text-slate-500">Mortgage Term</label>
    ...
    <fieldset class="flex flex-col mb-4 md:mb-0  md:flex-1  md:flex">
      ...
      ${radio}
    <div class="flex items-center justify-center mt-5 px-2 py-3  bg-lime rounded-3xl sm:w-[70%]">
